package it.develhope.exercise17;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        long myNewBalance = Long.valueOf(myBankBalanceEuro);
        myNewBalance = myNewBalance + questionableFundsEuro;
    ...
    public static void exercise3() {
        ...
        LocalDate myBirthday = LocalDate.of(2023,12,29);
        System.out.println(today.isBefore(myBirthday));
