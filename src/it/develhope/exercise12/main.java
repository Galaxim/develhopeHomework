...
public class main {
    ...
    public static double exercise1(String text, double expectedScore) {
        ...
        String firstStr = "Java runs on over 2 billion devices";
        String secondStr = "+31 2 58765446";
        String thirdStr = "hello world";
        int maxBaseScore = 20;
        yourScore = text.length();
        yourScore = Math.min(yourScore,maxBaseScore);
        if (text.contains("a")){
            yourScore -=5;
        }
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        if (yourMealScore < 5) {
            yourMealScore = Math.max(5, yourMealScore);
        }
