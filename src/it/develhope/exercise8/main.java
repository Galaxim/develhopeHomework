...
public class main {
    ...
    private static void exercise1() {
        ...
        ourNumberInt +=2;
        String numberStr = String.valueOf(ourNumberInt);
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5 ";
        String newStr = startStr.trim();
        int intStr = Integer.valueOf(newStr);
        intStr *=2;
        String returnStr = String.valueOf(intStr);
        String concatStr = returnStr + returnStr;
        double doubStr = Double.valueOf(concatStr);
        doubStr /=3.5;
        System.out.println(Math.floor(doubStr));
    }
}
